...
// SHA1算法
#define TXT_sha1							"1.3.14.3.2.26"

// SHA256算法
#define TXT_sha256							"2.16.840.1.101.3.4.2.1"

// RSA算法
#define TXT_rsa								"1.2.840.113549.1.1.1"

// SHA1RSA 
#define TXT_rsa_sha1						"1.2.840.113549.1.1.5"

// SHA256RSA 
#define TXT_rsa_sha256						"1.2.840.113549.1.1.11"

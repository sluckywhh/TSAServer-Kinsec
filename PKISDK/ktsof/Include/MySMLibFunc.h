...
long MYSM_Thread_Initialize();
long MYSM_Thread_Finalize();
...
///////////////////////////////////////////////////////////
// gmssl
#define KS_ENC_MODE_ECB	1
#define KS_ENC_MODE_CBC	2

#define KS_ENC_FLAG_ENC	0
#define KS_ENC_FLAG_DEC	1
...
// 结束SM4运算
// 填充方式，0表示不填充，1表示按照PKCS#5方式进行填充和去填充
long MYSM_SMS4FinalEx(
	HANDLE			hHandle,			// IN
	DWORD			padding,			// IN
	unsigned char	*in,				// IN
	long			inlen,				// IN

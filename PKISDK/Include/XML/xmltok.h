...
//##ModelId=3B949A4502FA
struct encoding {
	//##ModelId=3B949A450390
  int (*scanners[XML_N_STATES])(const ENCODING *,
			        const char *,
			        const char *,
			        const char **);
	//##ModelId=3B949A450387
  int (*literalScanners[XML_N_LITERAL_TYPES])(const ENCODING *,
					      const char *,
					      const char *,
					      const char **);
	//##ModelId=3B949A450386
  int (*sameName)(const ENCODING *,
	          const char *, const char *);
	//##ModelId=3B949A45037D
  int (*nameMatchesAscii)(const ENCODING *,
			  const char *, const char *);
	//##ModelId=3B949A45037C
  int (*nameLength)(const ENCODING *, const char *);
	//##ModelId=3B949A450372
  const char *(*skipS)(const ENCODING *, const char *);
	//##ModelId=3B949A450368
  int (*getAtts)(const ENCODING *enc, const char *ptr,
	         int attsMax, ATTRIBUTE *atts);
	//##ModelId=3B949A450355
  int (*charRefNumber)(const ENCODING *enc, const char *ptr);
	//##ModelId=3B949A450354
  int (*predefinedEntityName)(const ENCODING *, const char *, const char *);
	//##ModelId=3B949A45034B
  void (*updatePosition)(const ENCODING *,
			 const char *ptr,
			 const char *end,
			 XML_POSITION *);
	//##ModelId=3B949A45034A
  int (*isPublicId)(const ENCODING *enc, const char *ptr, const char *end,
		    const char **badPtr);
	//##ModelId=3B949A450341
  void (*utf8Convert)(const ENCODING *enc,
		      const char **fromP,
		      const char *fromLim,
		      char **toP,
		      const char *toLim);
	//##ModelId=3B949A450340
  void (*utf16Convert)(const ENCODING *enc,
		       const char **fromP,
		       const char *fromLim,
		       unsigned short **toP,
		       const unsigned short *toLim);
	//##ModelId=3B949A450322
  int minBytesPerChar;
	//##ModelId=3B949A45031A
  char isUtf8;
	//##ModelId=3B949A450319
  char isUtf16;
};
...
typedef struct INIT_ENCODING_tag {
  ENCODING initEnc;

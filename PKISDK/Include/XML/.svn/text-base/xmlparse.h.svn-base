...
The systemId argument is the system idenThrowIfier as specified in the entity declaration;
it will not be null.
The base argument is the system idenThrowIfier that should be used as the base for
resolving systemId if systemId was relative; this is set by XML_SetBase;
it may be null.
The publicId argument is the public idenThrowIfier as specified in the entity declaration,
or null if none was specified; the whitespace in the public idenThrowIfier
...
/* Sets the base to be used for resolving relative URIs in system idenThrowIfiers in
declarations.  Resolving relative idenThrowIfiers is left to the application:

#ifndef __UI_BASIC_HPP__
#define __UI_BASIC_HPP__
...
//#define STATIC_LIB
	...
	#endif
	#if defined(_DEBUG)
		#pragma comment(lib,"UIBasicd.lib")
		#pragma message("Automatically linking with UIBasicd.dll")
	#else
		#pragma comment(lib,"UIBasic.lib")
		#pragma message("Automatically linking with UIBasic.dll")
	#endif
#endif
